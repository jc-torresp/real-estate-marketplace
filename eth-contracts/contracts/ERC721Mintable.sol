...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "'to' address is already owner of this specific token");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _owner || isApprovedForAll(_owner, msg.sender), "Access denied, not allowed to call 'approve'");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0) && !to.isContract(), "'to' param is not a valid address.");
...
contract MyERC721Token is ERC721Metadata("My Real Estate Token", "MyRET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
